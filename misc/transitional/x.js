...
if(DM||E){d.write("<img src=0.gif id=PI name=PI width=20 height=32>")
...
if((E&7)==6){J=2;return 0}Rh[N]=[R.toString(),KL.toString(),K]
K=0
...
h='<table cellpadding=4 class=t>'
for(y=90;y>10;y-=10){h+="<tr>"
for(x=0;x<10;x++){z=y+x
if(x&&x<9){h+=('<td class='+(x+(y/10)&1?'b':'w')+'><a href="#" onclick="B(P?119-'+z+':'+z+');return false"><img src=0.gif width=7 height=40 border=0><img src=0.gif width=25 height=40 name=i'+z+' border=0><img src=0.gif width=7 height=40 border></a></td>\n')}}h+='</tr>\n'}h+='</table>'
d.write(h)
Rf(0)
